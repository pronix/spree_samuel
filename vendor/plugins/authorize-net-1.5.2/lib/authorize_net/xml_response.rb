module AuthorizeNetReports
  module AuthorizeNet
    ...
    # Instead you should use AuthorizeNetReports::AuthorizeNet::ARB::Response.
    class XmlResponse < AuthorizeNetReports::AuthorizeNet::Response

      # DO NOT USE. Instantiate AuthorizeNetReports::AuthorizeNet::ARB::Response or AuthorizeNetReports::AuthorizeNet::CIM::Response instead.
      ...
      def handle_node_type(xml, node_desc, node_name, args, base_name)
        ...
        when AuthorizeNetReports::AuthorizeNet::EntityDescription
